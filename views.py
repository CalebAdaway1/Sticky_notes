...
def note_new(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('note_detail', pk=note.pk)  # Redirect to the new note's detail page
    else:
...
def note_edit(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('note_detail', pk=note.pk)  # Redirect to the updated note's detail page
    else:
